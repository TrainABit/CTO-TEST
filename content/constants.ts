...
export const COMPARISON_METRIC_DEFINITIONS: ComparisonMetricDefinition[] = [
  ...
  },
  {
    ...
    description: 'How effectively the strategy converts every dollar of investment into EBITDA or enterprise value.',
    unit: 'score',
  ...
  },
  {
    ...
    description: 'Breadth of disciplines required day-to-day and the systems burden to achieve scale.',
    unit: 'score',
  ...
  },
  {
    ...
    description: 'Resilience of the model when growth stalls, including asset re-deployability and fixed cost exposure.',
    unit: 'score',
